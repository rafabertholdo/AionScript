...
// Type: AionInterface.AionEventRegisterHandler
...
{
  public delegate bool AionEventRegisterHandler(AionEventKeyHandler hFunction, Keys hKey, KeysModifier hModifier = KeysModifier.None);
}
