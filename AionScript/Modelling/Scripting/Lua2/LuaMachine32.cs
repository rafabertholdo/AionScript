...
// Type: AionScript.Modelling.Scripting.Lua.LuaMachine32
...
using LuaInterface_X86;
using System;
using System.IO;

namespace AionScript.Modelling.Scripting.Lua2
{
  public class LuaMachine32 : LuaMachine, VirtualMachineEngine
  {
    private Lua _hLua;

    public LuaMachine32(Stream hStream, object[] hObjectList)
